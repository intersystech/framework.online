...
using Intersystech.Utility.QRCode.Codec.Data;
using AlignmentPatternNotFoundException = Intersystech.Utility.QRCode.ExceptionHandler.AlignmentPatternNotFoundException;
using FinderPatternNotFoundException = Intersystech.Utility.QRCode.ExceptionHandler.FinderPatternNotFoundException;
using SymbolNotFoundException = Intersystech.Utility.QRCode.ExceptionHandler.SymbolNotFoundException;
using InvalidVersionException = Intersystech.Utility.QRCode.ExceptionHandler.InvalidVersionException;
using VersionInformationException = Intersystech.Utility.QRCode.ExceptionHandler.VersionInformationException;
using Intersystech.Utility.QRCode.Geom;
using Intersystech.Utility.QRCode.Codec.Reader.Pattern;
using Intersystech.Utility.QRCode.Codec.Util;
using SystemUtils = Intersystech.Utility.QRCode.Codec.Util.SystemUtils;

namespace Intersystech.Utility.QRCode.Codec.Reader
{
	...
	public class QRCodeImageReader
	{
		...
		internal virtual bool[][] getQRCodeMatrix(bool[][] image, SamplingGrid gridLines)
		{
			...
			canvas.drawPoint(bottomRightPoint, Intersystech.Utility.QRCode.Codec.Util.Color_Fields.BLUE);
