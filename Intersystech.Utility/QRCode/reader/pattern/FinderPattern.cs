...
using InvalidVersionInfoException = Intersystech.Utility.QRCode.ExceptionHandler.InvalidVersionInfoException;
...
namespace Intersystech.Utility.QRCode.Codec.Reader.Pattern
{
	...
	public class FinderPattern
	{
		...
		internal static Line[] findLineAcross(bool[][] image)
		{
			...
			canvas.drawLines(foundLines, Intersystech.Utility.QRCode.Codec.Util.Color_Fields.LIGHTGREEN);
			return foundLines;
		}
		...
		internal static Point[] getCenter(Line[] crossLines)
		{
			...
			{
				canvas.drawPolygon(foundPoints, Intersystech.Utility.QRCode.Codec.Util.Color_Fields.RED);
				return foundPoints;
			}
			else
		...
		internal static int calcExactVersion(Point[] centers, int[] angle, int[] moduleSize, bool[][] image)
		{
			...
			canvas.drawPoints(points, Intersystech.Utility.QRCode.Codec.Util.Color_Fields.RED);
