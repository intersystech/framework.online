...
using QRCodeImage = Intersystech.Utility.QRCode.Codec.Data.QRCodeImage;
using QRCodeSymbol = Intersystech.Utility.QRCode.Codec.Data.QRCodeSymbol;
using ReedSolomon = Intersystech.Utility.QRCode.Codec.Ecc.ReedSolomon;
using DecodingFailedException = Intersystech.Utility.QRCode.ExceptionHandler.DecodingFailedException;
using InvalidDataBlockException = Intersystech.Utility.QRCode.ExceptionHandler.InvalidDataBlockException;
...
using QRCodeDataBlockReader = Intersystech.Utility.QRCode.Codec.Reader.QRCodeDataBlockReader;
using QRCodeImageReader = Intersystech.Utility.QRCode.Codec.Reader.QRCodeImageReader;
using DebugCanvas = Intersystech.Utility.QRCode.Codec.Util.DebugCanvas;
using DebugCanvasAdapter = Intersystech.Utility.QRCode.Codec.Util.DebugCanvasAdapter;
using QRCodeUtility = Intersystech.Utility.QRCode.Codec.Util.QRCodeUtility;

namespace Intersystech.Utility.QRCode.Codec
{
