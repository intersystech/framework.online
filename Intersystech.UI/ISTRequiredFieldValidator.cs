...
namespace Intersystech.UI
{
    ...
    /// </summary>
    [ToolboxData(@"<{0}:ISTRequiredFieldValidator runat=""server"" ErrorMessageID=""ErrorMessageID""></{0}:ISTRequiredFieldValidator>")]
    public class ISTRequiredFieldValidator : RequiredFieldValidator
    {
        /// <summary>
